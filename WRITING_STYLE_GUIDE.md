...
- [ ] **最新情報を確認したか**（公式サイト、ニュースで最新モデル・価格・機能を確認）
- [ ] 絵文字を使用していないか（✅❌😊等）
...
1. **公式サイト確認**
   - 各ツールの公式ニュース・ブログページをweb_fetchで確認
   - 最新モデル名、発表日、バージョン番号を確認
   - 例: Anthropic → https://www.anthropic.com/news

2. **価格・仕様確認**
   - 公式価格ページで最新のAPI価格を確認
   - コンテキストウィンドウ、出力トークン数などの技術仕様
   - 例: https://www.anthropic.com/pricing

3. **ベンチマーク確認**
   - 公式発表された最新ベンチマーク結果
   - 第三者評価（Stanford HELM、Artificial Analysis等）

4. **記事更新日の明記**
   - 記事末尾の免責事項に必ず日付を記載
   - 例: 「本記事の情報は2026年2月13日時点のものです」

**古い情報を記載した場合:**
- 記事の価値が失われる（つとむ様の指摘事例: Claude 3.5 Sonnet → Opus 4.6）
- 読者の信頼を損なう
- すぐに修正が必要
