...
**ChatGPT (GPT-4 Turbo)**: 128,000トークン（約96,000語）

コンテキストウィンドウとは、AIが一度に処理できるテキストの長さを指す。Claude Opus 4.6は ChatGPTより約7.8倍長い文脈を保持できるため、長文書の分析やコードベース全体の理解において圧倒的な優位性を持つ。
