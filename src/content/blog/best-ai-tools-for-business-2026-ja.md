...
- Freeプランは使用量制限あり
- Proプランは月間使用量上限あり（具体的な上限は[Usage limit best practices](https://support.anthropic.com/en/articles/9797557-usage-limit-best-practices)を参照）
...
- [Gemini for Workspace (Google)](https://workspace.google.com/solutions/ai/)
- [Microsoft 365 Copilot (Microsoft)](https://www.microsoft.com/microsoft-365/copilot)
- [Slack AI (Salesforce)](https://slack.com/features/ai)
