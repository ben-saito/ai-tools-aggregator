# AI開発週報：AppleがDRAM制約を打破、Claude Fable 5がゲーム生成を民主化

2026年6月上旬は、AppleのWWDC 2026を軸にAI業界全体が大きな転換点を迎えた。デバイス上のAIエージェントが直面していたDRAMの制約をAppleが技術的に打破し、Anthropicが一般開発者にを開放したClaude Fable 5が「バイブコーディング」文化を加速させている。一方、OpenAIとAnthropicのIPO申請が同時に動き出し、AI産業の「成熟期」入りを印象づけている。
...
## WWDC 2026：Appleが「Siriの問題」を遂に解決

WWDC 2026のメインサプライズは、長年「Siri課題」と呼ばれてきた問題への本格的対応だった。Appleは「Siriが本当に望んでいたもの」というテーマで講演し、以下の機能を全新Siriの特徴として披露した：

- **文脈理解の飛躍**：過去の会話セッションを保持了し、連続的な対話が可能に
- **個人データの最適化活用**：カレンダー、メール、メッセージ、リマインダーなど端末内の情報を統合的に参照し、実用的な提案を実行
- **Apple Intelligenceのシステム全体統合**：AI生成機能がiOS 27全体に浸透

注目すべきは、WWDCで披露されたSiri刷新が、AFM 3の発表と密接に連携している点だ。Apple Intelligenceの中核にAFM 3の能力を活用することで、音声アシスタントの域を超えた**「AIファーストのパーソナルアシスタント」**への進化を目指している。

---

## Anthropic、Claude Fable 5公開——Mythosを一般開発者に開放
